  ...
  render() {
    return (
      <div>
        ...
        architecture with two Comoute Engine instance
        <ol>
          <li>
            Create a small(1 sahred vCPU + 1.7 GB memory) Compute Engine
            instance with the OS Ubuntu 16.04 xenial and with 'Allow HTTP
            traffic' chcked under Firewall section and name is{" "}
            <b>puppet-agent.</b>{" "}
          </li>
          <li>
            ...
            traffic alllow. Name the instance as <b>puppet-master</b>
          </li>
          <li>
            SSH into puppet-master and run the follwing comands to install
          ...
          <li>
            ...
            <code>
              sudo systemctl status puppetserver<br />
            </code>
          </li>
          ...
          <li>
            ...
            start at boot:
            <code>sudo systemctl enable puppetserver</code>
          </li>
          <li>
            Now SSH in to the puppet agent and run the follwing commands to
            install
            <a href="https://docs.puppet.com/puppet/3.8/install_debian_ubuntu.html">
              {" "}
              puppet
          ...
          <li>
            ...
            /etc/puppetlabs/code/environments/production/manifests/ by
            <code>
          ...
          <li>
            ...
            <code>cd /etc/puppetlabs/code/environments/production/modules</code>
            and then make a directory by
            <code>sudo mkdir -p webserver/manifests </code>
          </li>
          <li>
            in the above manifests directory create a file init.pp as
            <code>
              <br />class webserver {"{"}
              <br />&nbsp; package {"{"} 'apache2':
              <br />&nbsp;&nbsp; ensure => present
              ...
              <br />&nbsp;&nbsp; content => "{"<h1>"}This page is inatalled from Puppet Master{
                "</h1>"
              }", # content of the file
              <br /> &nbsp; {"}"}
              <br />
